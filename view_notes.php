<?php
    ...
    if(isset($_SESSION['username']))
    {
        ...
        elseif(isset($_POST['archive'])){
            ...
            $sql = "UPDATE tblcompose SET status = 'Archive' WHERE id = '$id'";
            $query_result = mysqli_query($conn, $sql);
            if($query_result){
                $_SESSION['SuccessMessage'] = "Your Note has been moved to archive";
            }
            else{
...
<html lang="en">
<head>
    <title>Private Diary - View Notes </title>
            ...
            <div class="content">
                <div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">View Note(s)</h4>
                        <ul class="breadcrumbs">
                            ...
                            <li class="nav-item">
                                <a href="view_notes.php">View Note(s)</a>
                            </li>
                        </ul>
                    </div>
                                    ...
                                    <div id="basic-datatables_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                                        <div class="row">
                                            ...
                                            <table class="table table-striped mt-1">
                                                ...
                                                <?php
                                                $i = 0;
                                                $sql = "SELECT * FROM tblcompose WHERE username = '{$_SESSION['username']}' AND status = 'Un-Archive' ORDER BY date ASC";
                                                $query_result = mysqli_query($conn, $sql);
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <!-- View Starts Here -->
                                                            <form action="view.php?id=<?php echo $note_id; ?>" method="POST" >
                                                                <input type="hidden" value="<?php echo $note_id; ?>" name="id">
                                                                <input type="submit" name="view" class="btn btn-info btn-sm m-1" value="View">
                                                            </form>
                                                            <!-- View Ends Here -->
                                                            ...
                                                            <form action="view_notes.php" method="POST">
                                                                <input type="hidden" value="<?php echo $note_id; ?>" name="id">
                                                                <input type="submit" name="archive" class="btn btn-warning btn-sm m-1" value="Archive">
                                                            </form>
                                                            <!-- Archive Ends Here -->

                                                            <!-- Edit Starts Here -->
                                                            <form action="edit_compose.php?id=<?php echo $note_id; ?>" method="POST">
                                                                <input type="hidden" value="<?php echo $note_id; ?>" name="id">
                                                                <input type="submit" name="edit" value="Edit" class="btn btn-secondary btn-sm m-1" data-toggle="modal" data-target="#addNoteModal">
                                                            </form>
                                                            <!-- Edit Ends Here -->
